...
async function navigate(name){
  ...
  skeleton();try{if(name==='dashboard')await renderDashboard(generation);if(name==='users')await renderUsers(generation);if(name==='admins')await renderAdmins(generation);if(name==='audit')await renderAudit(generation)}catch(error){if(generation===navigationGeneration&&state.view===name)errorState(error)}
}
